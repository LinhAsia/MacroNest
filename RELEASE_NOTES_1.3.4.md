...
- Screen recording uses Windows Graphics Capture at 60 FPS and Media Foundation H.264 encoding to minimize CPU use and input lag.
- Screen recording automatically uses hardware H.264 when available and keeps video streams untouched while muxing audio.

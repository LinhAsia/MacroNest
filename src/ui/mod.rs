            ...
            if preset_enabled {
                if window_focus_trigger {
                    ...
                    if dark_mode {
                        ...
                        (
                            Color32::from_rgb(200, 238, 212),
                            Color32::from_rgb(64, 146, 98),
                        )
                    }
                }
            } else {
            ...
            if preset_enabled {
                if window_focus_trigger {
                    ...
                    if dark_mode {
                        ...
                        (
                            Color32::from_rgb(228, 236, 232),
                            Color32::from_rgb(156, 176, 164),
                        )
                    }
                }
            } else {
